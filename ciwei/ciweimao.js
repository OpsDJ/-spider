...
// 读取文件内容
var content = fs.readFileSync('chapter_content.txt', 'utf8');

// 读取密钥
var keys = fs.readFileSync('encryt_keys.txt', 'utf8');
var keysObj = JSON.parse(keys)
// 读取访问密钥
var accessKey = fs.readFileSync('chapter_access_key.txt', 'utf8');
